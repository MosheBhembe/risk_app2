...
*/
app.post('/report-incident-data', async (Request, Response) => {
    ...
    emailConfigurations.sendMail(sendInfo, async (error, info) => {
        if (error) {
...
app.post('/fuel-consumption', upload.single('image'), async (Request, Response) => {
...
app.post('/near-hit', async (Request, Response) => {
...
app.post('/tyre-change-data', async (Request, Response) => {
